        ...
        */
        ...
        if (!go.prefs.skipChecks) {
            ...
            if (Blob) {
                ...
                // So to truly login it we need to make a login Blob():
                try {
...
GateOne.Base.update(GateOne.Utils, {
    ...
    // startBenchmark and stopBenchmark can be used to login the performance of various functions and code...
...
//                     console.log('Running: ' + moduleObj.__name__ + '.postInit()');
    ...
    setCookie: function(name, value, days) {
        ...
        Examples:
            ...
            >>> GateOne.Utils.setCookie('login', 'some value', 30); // Sets the 'login' cookie to 'some value' with an expiration of 30 days
        */
        var exdate=new Date();
...
GateOne.Base.update(GateOne.Net, {
    ...
    log: function(message) {
        ...
        When developing a new action, you can login out or debug your server-side messages by attaching the respective action to :js:func:`GateOne.Net.log` like so:
...
//         logDebug('applyTransform(' + typeof(obj) + ', ' + transform + ')');
    ...
    displayMessage: function(message, /*opt*/timeout, /*opt*/removeTimeout, /*opt*/id, /*opt*/noLog) {
        ...
        If *id* is given, it will be prefixed with :js:attr:`GateOne.prefs.prefix` and used as the DIV ID for the pop-up.  i.e. ``GateOne.prefs.prefix+id``.  The default is ``GateOne.prefs.prefix+"notice"``.
            ...
            >>> GateOne.Visual.displayMessage('This is a login.');
